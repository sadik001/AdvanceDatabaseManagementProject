...
<br><br>
  ...
  <div class="row">
    <div class="col-md-12 text-center">
      <a class="animate1st-charcter"> Welcome Back! <br> Dear Admin <br> <?php echo $adminname ?> </a><br><br><br>
    </div>
<p>List of orders more than 500$<p>
     <?php
        ...
        $stid = oci_parse($conn, 'SELECT * FROM user_orders WHERE PRODUCT_TOTAL > 500');
        oci_execute($stid);
        echo "<table border='1'>
        <tr>
            <th>Item Name</th>
     ...
     <p>List of orders less than 500$<p>
     <?php
        $conn = oci_connect('pritom', 'tree', '//localhost/XE');   
        if (!$conn) {
          echo 'Failed to connect to oracle' . "<br>";
     ...
     <?php
        ...
        $stid = oci_parse($conn, 'select email, item_name, price, quantity, product_total from user_orders, user_data where user_orders.ID=user_data.ID');
        oci_execute($stid);
        echo "<table border='1'>
        <tr>
