            ...
            $id=$row['ID'];
                 ...
                 foreach ($_SESSION['cart'] as $key => $value) 
                   { 
                        ...
                        echo "string";
                        //order
                        $query2 = "INSERT INTO user_orders(ORDER_ID,ID, ITEM_NAME, PRICE, QUANTITY, PAY_METHOD,PRODUCT_TOTAL) VALUES (seq_order_id.NEXTVAL,'$id','$Item_Name','$Price','$Quantity','$pay_method','$Product_total')";
                        
                        $stid = oci_parse($con, $query2);
