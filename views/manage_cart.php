  	...
  	if (isset($_POST["Add_to_Cart"])) 
   {
       if(isset($_SESSION['cart'])) //firstly there is no index which is 'cart' in $_SESSION
       {
            ...
            else
           {
              ...
              $_SESSION['cart'][$count]=array('Item_Name' => $_POST['Item_Name'],'Price' => $_POST['Price'],'Quantity' => 1, 'Product_total' => 1, 'Total_price'=>$_POST['Price']);
                echo"<script>
         	    alert('Item Added');
         	    window.location.href='index.php';
         	    </script>";      
           ...
           {
               $_SESSION['cart'][0]=array('Item_Name' => $_POST['Item_Name'],'Price' => $_POST['Price'],'Quantity' => 1, 'Product_total' => 1, 'Total_price'=>$_POST['Price']);
                echo"<script>
         	    alert('Item Added');
         	    window.location.href='index.php';
         	    </script>";
   ...
   if (isset($_POST["Mod_Quantity"])) 
   {
   	foreach ($_SESSION['cart'] as $key => $value) 
  	  { 
         ...
         $_SESSION['cart'][$key]['Total_price']=$_POST['Mod_Quantity']*$_SESSION['cart'][$key]['Total_price'];
  	  	 /*print_r($_SESSION['cart']);*/
  	     echo"<script>
  	     window.location.href='mycart.php';
  	     </script>
